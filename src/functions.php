...
if ( function_exists( 'add_theme_support' ) ) {
    ...
    load_theme_textdomain( 'tartatheme', get_template_directory() . '/languages' );
}
...
function tartatheme_header_scripts() {
    if ( $GLOBALS['pagenow'] != 'wp-login.php' && ! is_admin() ) {
        if ( HTML5_DEBUG ) {
            // jQuery
            wp_deregister_script( 'jquery' );
            wp_register_script( 'jquery', get_template_directory_uri() . '/js/lib/jquery-1.11.1.min.js', array(), '1.11.1' );
            ...
            // Enqueue Scripts
            wp_enqueue_script( 'tartathemescripts' );

        // If production
        } else {
            // Scripts minify
            wp_register_script( 'tartathemescripts-min', get_template_directory_uri() . '/js/scripts.min.js', array(), '1.0.0' );
            // Enqueue Scripts
            wp_enqueue_script( 'tartathemescripts-min' );
        }
    }
}

// Load HTML5 Blank conditional scripts
function tartatheme_conditional_scripts() {
...
function tartatheme_styles() {
    if ( HTML5_DEBUG ) {
        ...
        // Register CSS
        wp_enqueue_style( 'tartathemecssmin' );
    }
}
...
function register_html5_menu() {
    register_nav_menus( array( // Using array to specify more menus if needed
        'header-menu'  => esc_html( 'Header Menu', 'tartatheme' ), // Main Navigation
        'extra-menu'   => esc_html( 'Extra Menu', 'tartatheme' ) // Extra Navigation if needed (duplicate as many as you need!)
    ) );
}
...
if ( function_exists( 'register_sidebar' ) ) {
    ...
    register_sidebar( array(
        'name'          => esc_html( 'Widget Area 1', 'tartatheme' ),
        'description'   => esc_html( 'Description for this widget-area...', 'tartatheme' ),
        'id'            => 'widget-area-1',
    ...
    register_sidebar( array(
        'name'          => esc_html( 'Widget Area 2', 'tartatheme' ),
        'description'   => esc_html( 'Description for this widget-area...', 'tartatheme' ),
        'id'            => 'widget-area-2',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget'  => '</div>',
...
function html5_blank_view_article( $more ) {
    global $post;
    return '... <a class="view-article" href="' . get_permalink( $post->ID ) . '">' . esc_html_e( 'View Article', 'tartatheme' ) . '</a>';
}
...
function tartathemegravatar ( $avatar_defaults ) {
...
function tartathemecomments( $comment, $args, $depth ) {
...
// Add Actions
add_action( 'wp_enqueue_scripts', 'tartatheme_header_scripts' ); // Add Custom Scripts to wp_head
add_action( 'wp_print_scripts', 'tartatheme_conditional_scripts' ); // Add Conditional Page Scripts
...
// Add Filters
add_filter( 'avatar_defaults', 'tartathemegravatar' ); // Custom Gravatar in Settings > Discussion
